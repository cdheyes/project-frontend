...
export const Navbar = () => {
    return (
        <div className = "navContainer">
            ...
            <NavLink activeClassName="active_styles" exact to="/food"><li><IconContext.Provider value={{ className: "react-icons" }}> <MdOutlineFastfood/></IconContext.Provider>Restaurant</li></NavLink>
            <NavLink activeClassName="active_styles" exact to="/restaurant"><li><IconContext.Provider value={{ className: "react-icons" }}> <MdOutlineFoodBank/></IconContext.Provider>Food</li></NavLink>
